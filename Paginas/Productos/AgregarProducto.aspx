<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgregarProducto.aspx.cs" Inherits="TareaEvaluada.Paginas.Productos.AgregarProducto" %>
...
<body>
    <!-- Esta pagina Tiene como objetivo que se pueda agregar productos, 
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <br />
            <!--Boton para Registrar al nuevo producto, llama al procedimiento btnRegistrar_Click-->
            <asp:Button ID="btnAgregar" Text="Registrar" runat="server" CssClass="Botones" OnClick="btnAgregar_Click" />
            <br />
            <br />
